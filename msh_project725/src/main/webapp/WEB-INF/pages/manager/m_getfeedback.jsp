...
<body>
<%
    List<T_Feedback> tf= (List<T_Feedback>) request.getAttribute("state0");
    ...
    <div id="d2">
        ...
        <table border=":solid 1px "  style="margin:auto;">
            ...
            <tr>
                ...
                <td><%=tR.getR_job()%></td>
                <td>
                    <a href="getmresume?a=1&f_id=<%=tf.get(i).getF_id()%>&f_read=<%=tf.get(i).getF_read()%>
                ...
                <td>
                    <a href="updatestate15?state=1&f_id=<%=tf.get(i).getF_id()%>"><button >发出邀请</button></a>
                </td>
                <td>
                    <a href="updatestate15?state=5&f_id=<%=tf.get(i).getF_id()%>"><button >不符合</button></a>
                </td>
            </tr>
