...
<body>
    <%
       T_Emp te= (T_Emp) session.getAttribute("emp");
...
<div  id="da">
    <div id="d1">
        <h2>员工信息修改</h2>
        <div id="d4">&nbsp;&nbsp; <span><a id="a1" href="empjsp">员工主界面</a></span>
            ...
            <form  method="post" action="updateEMP2">
                <table border=":solid 1px "  style="margin:auto;">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="n2" name="e_password"
                                   value="<%=te.getE_password()%>"></td>
                    </tr>
                    <tr>
                        <td><label>电话号码</label></td>
                        <td><input type="text" id="n1" name="e_tel"
                                   value="<%=te.getE_tel()%>"></td>
                    </tr>
                    <tr>
                        <td><label>住址</label></td>
                        <td><input type="text" id="n3" name="e_address"
                                   value="<%=te.getE_address()%>"></td>
                    </tr>


                </table>
                <input type="hidden" name="e_id" value="<%=te.getE_id()%>">
